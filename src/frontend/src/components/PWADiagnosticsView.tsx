      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-muted-foreground">
              {diagnostics.manifestFetchStatus === "success" &&
                "Manifest carregado com sucesso"}
              {diagnostics.manifestFetchStatus === "error" &&
                `Erro: ${diagnostics.manifestError}`}
              {diagnostics.manifestFetchStatus === "pending" &&
                "Verificando..."}
            </span>
          </div>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    O app está rodando em modo standalone sem problemas
                    detectados.
                  </p>
                </div>
              </div>
        ...
        <div className="pt-4 border-t border-border/50">
          <p className="text-xs text-muted-foreground">
            <strong>Nota:</strong> Se o app não está instalando corretamente no
            Android, verifique se:
          </p>
