...
export default function UserPreferences() {
  ...
  const [prioritizeFavouritesForLearning, setPrioritizeFavouritesForLearning] =
    useState(() => {
  ...
  return (
    <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Receba notificações para novas detecções radar e
                      recomendações de alta confiança
                    </p>
                  </div>
                  <Switch
                    id="alerts-toggle"
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      A I.A. dará preferência aos seus ativos favoritos durante
                  ...
                  favouriteAssets.length === 0 && (
                    <div className="mt-4 p-3 rounded-lg bg-neon-orange/10 border border-neon-orange/30">
                      <p className="text-sm text-neon-orange">
                        ⚠️ Selecione ativos favoritos acima para ativar a
                        priorização
                      </p>
                    </div>
                  )}
                  ...
                  favouriteAssets.length > 0 && (
                    <div className="mt-4 p-3 rounded-lg bg-neon-purple/10 border border-neon-purple/30">
                      <p className="text-sm text-neon-purple">
                        ✓ I.A. priorizando {favouriteAssets.length} ativo
                        {favouriteAssets.length > 1 ? "s" : ""} favorito
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Clear all local data and start fresh. This will delete AI
                      learning history, preferences, and cached data.
                    </p>
                  </div>
                  <Button
                    variant="destructive"
      ...
      <Card className="border-2 border-neon-cyan/30 bg-card/60 backdrop-blur-sm">
        <CardHeader>
          <CardTitle className="text-lg text-neon-cyan">
        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>
                <span className="text-neon-pink">Dark Neon</span>: Tema original
                com tons roxo/rosa vibrantes
              </li>
              <li>
                <span className="text-neon-cyan">Cyber Glow</span>: Novo tema
                com tons azul/teal suaves
              </li>
              <li>
                <span className="text-neon-green">Alertas Dinâmicos</span>:
                Notificações visuais e sonoras para eventos importantes
              </li>
              <li>
                <span className="text-neon-orange">Ativos Favoritos</span>:
                Alertas prioritários para seus ativos preferidos
              </li>
              <li>
                <span className="text-neon-purple">Aprendizado I.A.</span>:
                Priorize favoritos para aprendizado mais focado
              </li>
              <li>
                <span className="text-destructive">Reload from Scratch</span>:
