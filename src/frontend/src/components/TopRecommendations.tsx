    ...
    <Card className="border-2 border-neon-green/30 bg-card/60 backdrop-blur-sm shadow-neon-bullish">
      <CardHeader>
        ...
        <CardDescription className="text-base">
          Assets with highest upside potential based on advanced algorithmic
          analysis, predictive confidence and continuous learning
        </CardDescription>
      </CardHeader>
      <CardContent>
        {!hasRecommendations ? (
          <Alert className="border-2 border-neon-cyan/40 bg-neon-cyan/10">
            ...
            <AlertDescription className="text-muted-foreground">
              ...
              recommendations automatically. Recommendations will appear shortly
              based on Smart Money Concepts, Volume Delta, Liquidity analysis,
              institutional order detection and continuous AI learning.
            </AlertDescription>
          </Alert>
        ) : (
          <ScrollArea className="h-[700px] pr-2 overflow-x-hidden">
            <div className="space-y-4 min-w-0">
              {topRecs.map((rec, index) => {
                ...
                const hasLearning =
                  rec.market && (rec.market.analysis.learningLevel || 0) >= 0.6;
                return (
                  <Card
                        ...
                        <>
                          <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 min-w-0">
                            ...
                            <div className="space-y-1 p-2 sm:p-3 rounded-lg bg-accent/30 border border-neon-blue/30 min-w-0">
                              ...
                              <p className="text-base sm:text-lg font-bold text-neon-blue truncate">
                                $
                                {(
                                  Number.parseFloat(rec.market.quoteVolume) /
                                  1000000
                                ).toFixed(1)}
                                M
                              </p>
                          ...
                          <div className="space-y-2 min-w-0">
                            ...
                            <p className="text-sm text-muted-foreground leading-relaxed break-words">
                              Strong {rec.market.analysis.trend} trend detected
                              with {rec.strength.toFixed(0)}% strength.
                              Technical analysis shows{" "}
                              {rec.market.analysis.confidence >= 0.7
                                ? "high"
                                : "moderate"}{" "}
                              confidence based on price action, volume analysis,
