              ...
              <div className="p-4 rounded-lg bg-neon-cyan/10 border border-neon-cyan/30">
                ...
                <ol className="space-y-3 text-sm text-muted-foreground list-decimal list-inside">
                  <li className="pl-2">
                    ...
                    <span className="inline-block text-lg">⎋</span> na barra
                    inferior do Safari
                  </li>
                  <li className="pl-2">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-neon-orange/10 border border-neon-orange/30">
                <p className="text-sm text-muted-foreground">
                  Clique no botão abaixo para instalar o aplicativo. Ele será
                  adicionado à sua tela inicial e poderá ser acessado como um
                  app nativo.
                </p>
              </div>
              <Button
