...
export default function PredictiveConfidencePanel({
  ...
  symbol: _symbol,
  compact = false,
}: PredictiveConfidencePanelProps) {
        ...
        <div className="relative w-full h-2 bg-muted rounded-full border border-border overflow-hidden">
          ...
          <div
            ...
            style={{
              ...
              background:
                "linear-gradient(90deg, transparent, oklch(var(--neon-cyan) / 0.3), transparent)",
            }}
          />
        </div>
      </div>
  ...
  return (
    <Card
      className={cn(
        ...
        isHighConfidence &&
          "border-neon-green/40 bg-neon-green/5 shadow-neon-bullish",
        isMediumConfidence &&
          "border-neon-cyan/40 bg-neon-cyan/5 shadow-neon-md",
        !isHighConfidence &&
          !isMediumConfidence &&
      ...
      <CardContent className="p-4 sm:p-6">
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            {!isHighConfidence &&
              !isMediumConfidence &&
              " Sinal fraco, aguardar confirmação."}
          </p>
        </div>
      </CardContent>
    </Card>
