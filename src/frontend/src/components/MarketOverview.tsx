...
export default function MarketOverview() {
  ...
  const isPositive = selectedMarket
    ? selectedMarket.priceChangePercent >= 0
    : false;
  const hasManipulationZones =
    selectedMarket && selectedMarket.analysis.manipulationZones.length > 0;
  const hasInstitutionalOrders =
    selectedMarket && selectedMarket.analysis.institutionalOrders.length > 0;
  const hasLearning =
    selectedMarket && (selectedMarket.analysis.learningLevel || 0) > 0;
      ...
      <Card className="border-2 border-neon-cyan/30 bg-card/60 backdrop-blur-sm shadow-neon-md">
        <CardHeader>
          ...
          <CardDescription className="text-base">
            Live data from Binance Futures USD-M with advanced predictive
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-base">
                  Detailed Analysis with Predictive Intelligence
                </CardDescription>
              </div>
              <Badge
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground">
                    Based on SMC analysis, volume delta, momentum and price
                    structure
                  </p>
                </div>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center gap-2 mb-3">
                          <img
                            ...
                            className="w-6 h-6"
                          />
                          <h4 className="text-sm font-bold text-neon-purple">
              ...
              >
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Based on algorithmic analysis of SMC, Volume Delta, Liquidity
                  and Fair Value Gaps
